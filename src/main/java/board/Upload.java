...
//        }
        	...
        	//여러개 파일을 보낼 경우, 아직 진행중
    	Part filePart = null;
        List<String> fileList = new ArrayList<>();
        for (int i=1; i<=2; i++) {			//name이 file1, file2
        ...
        //response.getWriter().print("The file " + fileName + "is uploaded sucessfully."); 한글이 계속 깨져서 뺌	
	}

}
/* 초기 설정으로 파일 한개 업로드 진행해본 결과
 * 
 * 웹 페이지는 한글 깨져서 나옴, The file ????.jpgis uploaded sucessfully. 출력
 * tmpPath: c:/Temp/upload
 * param: 파라메터
 * fileName: 길고양이.jpg
 * 
 * 잘 나옴!
